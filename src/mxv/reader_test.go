...
func TestNewReader(t *testing.T) {
	tests := []struct {
		...
		{
			filepath: filepath.Join("..", "..", "sample-files", "Vergleich2.mxv"),
			mxvInfo: mxv.Info{
		...
		{
			filepath: filepath.Join("..", "..", "sample-files", "23.976p.mxv"),
			mxvInfo: mxv.Info{
		...
		{
			filepath: filepath.Join("..", "..", "sample-files", "24p.mxv"),
			mxvInfo: mxv.Info{
		...
		{
			filepath: filepath.Join("..", "..", "sample-files", "25i.mxv"),
			mxvInfo: mxv.Info{
		...
		{
			filepath: filepath.Join("..", "..", "sample-files", "50p.mxv"),
			mxvInfo: mxv.Info{
		...
		{
			filepath: filepath.Join("..", "..", "sample-files", "60p.mxv"),
			mxvInfo: mxv.Info{
